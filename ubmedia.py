...
from pyrogram import MessageFilter
...
def clean_data():
    print("checking media")
        for ids in ub.search_messages(chat_id=group, filter.photo, limit=20):
            for ids in ub.search_messages(chat_id=group, filter.video, limit=20):
